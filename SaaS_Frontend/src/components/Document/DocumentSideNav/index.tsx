...
const tabOptions = [
  { key: "all-docs", label: "All Docs", icon: <LuFileStack /> },
  { key: "my-docs", label: "My Docs", icon: <LuFileUser /> },
  { key: "favorites", label: "Favorites", icon: <PiFolderSimpleStarFill /> },
  { key: "distributed", label: "Distributed", icon: <FaFileCircleCheck /> },
  { key: "inWorkflow", label: "InWorkflow", icon: <VscReferences /> },
