    ...
    if (inputMessage.trim()) {
      ...
      if (
        ...
        const selectedLocationName = selectedOption
          ...
          : null;
        body.locationName = selectedLocationName;
      }
      if (selectedEntity && selectedEntity !== "All" && selectedEntity !== "") {
        ...
        body.entityName = selectedEntityName;
      }
      ...
      try {
        ...
        const res = await axios.post(
          `${process.env.REACT_APP_PY_URL}/pyapi/chat_capa`,
          body
        );
                    ...
                    <ul>
                      {item.sources.map((source: any, idx: any) => (
                        <li key={idx}>
                          ...
                          <p>Problem Statement: {source.ProblemStatement}</p>
                          <p>Entity: {source.entity}</p>
...
export default CapaChatComponent;
