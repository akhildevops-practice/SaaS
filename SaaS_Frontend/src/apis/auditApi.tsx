...
export const getAllTemplates = async (
  ...
  let result;
  try {
    const selectedLoc = encodeURIComponent(JSON.stringify(selectedSystem));
    result = await axios(
      `/api/audit-template?skip=${skip}&limit=${limit}&search=${searchText}&selectedLoc=${selectedLoc}`
    );

    console.log("result from checklist", result);
    return result;
  } catch (error) {}
};
...
export const searchTemplateNew = async (
  title: string = "",
  skip: number,
  limit: number
) => {
  ...
  try {
    result = await axios.get(
      `${API_LINK}/api/audit-template/searchForTemplate?search=${title}&skip=${skip}&limit=${limit}`
    );
    return result;
  } catch (error) {}
};
...
export const getExcelDetails = async (formData: any) => {
  let result;
  try {
    result = await axios.post(
      `${API_LINK}/api/audit-template/getExcelDetails`,
      formData
    );
    return result;
  } catch (error) {}
...
export const getAllAuditTypes = async () => {
  let result;
  try {
    result = await axios.get(`/api/audit-settings/getAllAuditTypes`);
    return result;
  } catch (error) {
    return error;
  }
...
export const getAllAuditorsNew = async (formData: any) => {
  let result;

  try {
    const systemData = formData?.system
      ?.map((value: any) => {
        return `&system[]=${value}`;
      })
      .join("");
      console.log("systemData",systemData,formData?.system)
    result = await axios.get(
      `/api/auditSchedule/getAuditors?auditType=${formData?.auditType}&location=${formData?.location}${systemData}&dept=${formData.auditedEntity}`
    );
    return result;
  } catch (error) {
    return error;
...
export const addAttachment = async (
  ...
  try {
    result = await axios.post(
      `${API_LINK}/api/audits/attachment?realm=${realm}&locationName=${location}`,
      payload
    );
    return result;
  } catch (error) {
...
/**
 * @method getAuditForPdf
 * @description Function to retrieve a audit
 * @param payload {any}
 * @returns
 */
export const getAuditForPdf = async (id: string) => {
  let result;
  try {
    result = await axios.get(`${API_LINK}/api/audits/getAuditDtlsForPdf/${id}`);
    return result;
  } catch (error) {
    return error;
  }
...
export const fetchAuditReportTableData = async (
  ...
  try {
    result = await axios.get(
      `${API_LINK}/api/audits/search/${currentyear}?myDept=${myDept}&auditYear=${auditYear}&location=${location}&auditedEntity=${auditedEntity}&auditType=${auditType}&system=${systemName}&auditor=${auditor}&skip=${skip}&limit=${limit}&${columnfilterurl}&auditTypeNew=${auditedType}`
    );
    return result;
  } catch (error) {}
};

export const searchAuditTableData = async (
  text: any,
  skip: any,
  limit: any
) => {
  ...
  try {
    result = await axios.get(
      `${API_LINK}/api/audits/searchaudit?search=${text}&skip=${skip}&limit=${limit}`
    );
    return result;
  } catch (error) {}
};

export const myAudit = async (skip: any, limit: any) => {
  let result;
  try {
    result = await axios.get(
      `${API_LINK}/api/audits/myAudit?skip=${skip}&limit=${limit}`
    );
    return result;
  } catch (error) {}
};
 ...
 */
export const addAuditReportData = async (payload: any) => {
  try {
    const res = await axios.post(`${API_LINK}/api/audits`, payload);
    return {
      success: true,
      respond: res.data,
    };
...
export const getAuditById = async (id: string) => {
  try {
    const response = await axios.get(`${API_LINK}/api/audits/${id}`);
    return {
      success: true,
