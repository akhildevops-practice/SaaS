...
const useStyles = makeStyles<Theme>((theme: Theme) => ({
  ...
  titleRow: {
    ...
    alignItems: "center",
    // Add a light bottom border so this header feels separated:
    borderBottom: "1px solid #e0e0e0",
    paddingBottom: "12px",
    marginBottom: "24px",
  },
  descriptionAssessmentTeam : {
  ...
  titleGroup: {
    ...
    // Ensures the “Back” link and the Title stack nicely on very narrow screens:
    gap: 4,
  },
  backText: {
    fontSize: "14px",
  ...
  submitButton: {
    // Adjust sizing to make it stand out more—
    // you can remove width if you prefer “auto.”
    minWidth: "180px",
  },
