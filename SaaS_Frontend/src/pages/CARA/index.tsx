...
import CaraSideNav from "./CaraSideNav";
...
const CaraHomePage = () => {
  ...
  const [ttsModalOpen, setTTSModalOpen] = useState<boolean>(false);
...
${data?.correctedDate}
  ...
  // console.log("active tab",acitveTab)
  return (
    <div
    ...
    >
      ...
      <CaraSideNav
        ...
        isSettingsAccess={isOrgAdmin || isMr}
      ...
      <div style={{ flex: 1, overflow: "auto", padding: "0px 16px" }}>
        ...
        >
          <Typography
            variant="h5"
            style={{ fontWeight: 600, marginLeft: "22px" }}
          >
            {acitveTab === "1"
              ? "CAPA Details"
              : acitveTab === "settings"
          ...
          {/* Controls: Search + Toggle Filters + Right Actions */}
          {acitveTab === "1" && (
            <div
              style={{
                display: "flex",
            ...
            >
              ...
              >
                <Input
                  ...
                  prefix={<AiOutlineSearch size={18} color="#6b7280" />}
              ...
              {/* Right Side: Chat + Create */}
              <div
                style={{ display: "flex", alignItems: "center", gap: "10px" }}
              >
                {activeModules?.includes("AI_FEATURES") && (
                  <>
                    <Tooltip title="Chat With CAPA">
                      <Button
                        style={{
                          borderRadius: "20px",
                          padding: "5px 20px",
        ...
        {/* Filters Row (conditionally visible) */}
        {acitveTab === "1" && showFilters && (
          <div
            style={{
              display: "flex",
              gap: "20px",
        ...
        {acitveTab === "1" && (
          <>
            ...
            {/* {ttsModalOpen && (
              <TTSComponent
                ttsModalOpen={ttsModalOpen}
                toggleTTSModal={toggleTTSModal}
              ></TTSComponent>
            )} */}
          </>
        )}
        ...
        {/* {acitveTab === "settings" && <>navigate("/cara/settings");</>} */}
      </div>
    </div>
  );
};
