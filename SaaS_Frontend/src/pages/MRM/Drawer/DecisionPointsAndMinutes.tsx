...
const DecisionPointsAndMinutes = ({
    ...
    const addData = () => {
        const newSource: any = dataSource && dataSource?.length ? [...dataSource] : [];
        newSource.push({
            decisionPoints: ''
        });
                                                ...
                                                <>
                                                    <Row gutter={[16, 16]} key={key}>
                                                        ...
                                                        <Col span={2}>
                                                            ...
                                                            <AiOutlineMinusCircle style={{ height: '100%', display: 'flex', alignItems: 'center' }} onClick={() => { showData && remove(name); removeData(name) }} />
                                                        </Col>
                                                    </Row>
