...
const ByDepartmentChart = ({
  ...
  useEffect(() => {
    ...
    const counts = deptData.map((d: any) => d.count);
    ...
    chartInstance.current = new ChartJS(ctx, {
      type: "bubble",
      data: {
        datasets: deptData?.map((value: any, index: number) => {
      ...
      options: {
        ...
        plugins: {
          ...
          title: {
            display: true,
            align: "start",
            text: "Published Documents By Department",
            font: {
              size: 14,
              weight: "600",
        ...
        onClick: (e, index: any) => {
          ...
          if (typeof datasetIndex === "number") {
            setFilterQuery({
              entityId: deptData[datasetIndex]?.entityId,
            });
          }
        },
      },
